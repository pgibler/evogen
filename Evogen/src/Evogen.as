package 
{
	...
	public class Evogen extends Sprite 
	{
		...
		private function testGA():void
		{
			...
			var breederSettings:BreederSettings = new BreederSettings(new RankBreeder(2.0/3.0), new FighterSpecimenEvaluator(), 200, 100);
		...
		private function testGame():void
		{
			...
			var p1dna : String = "";
			var p2dna : String = "";
